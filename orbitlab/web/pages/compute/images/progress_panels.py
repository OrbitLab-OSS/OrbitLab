            ...
            tailwind.FieldSet(
                ...
                tailwind.FieldSet.Field(
                    ...
                    tailwind.Select(
                        ...
                        default_value=CustomImageDialogState.form_data.get("base_image_id", ""),
            ...
            tailwind.FieldSet(
                ...
                tailwind.FieldSet.Field(
                    ...
                    tailwind.Select(
                        ...
                        default_value=CustomImageDialogState.form_data.get("storage", SelectionDefaults.default_import_storage).to(str),
                ...
                tailwind.FieldSet.Field(
                    ...
                    tailwind.Select(
                        ...
                        default_value=CustomImageDialogState.form_data.get("disk_storage", SelectionDefaults.default_images_storage).to(str),
                        placeholder="Select Storage",
                        name="disk_storage",
                        required=True,
                        class_name="w-full",
        ...
        return rx.fragment(
            tailwind.DataList(
                ...
                tailwind.DataList.Item(
                    ...
                    tailwind.DataList.Value(CustomImageDialogState.form_data.get("base_image_id")),
                ),
                tailwind.DataList.Item(
