...
class DiscoveryService:
    ...
    # async def discover_nodes(self, manifest: ClusterManifest) -> None:
    #     ha_status = await self.cluster.get_ha_status()
    #     storage_resources = await self.cluster.list_storage_resources()
    #     custer_status = await self.cluster.get_status()
    #     for node in custer_status.get_nodes():
